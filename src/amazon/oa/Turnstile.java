...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Turnstile Pass = " + Arrays.toString(getTimes(numCustomers1, arrTime1, direction1)));
        System.out.println("************** Test **************");
        ...
        System.out.println("Turnstile Pass = " + Arrays.toString(getTimes(numCustomers2, arrTime2, direction2)));
        System.out.println("************** Test **************");
    }
