...
public class LargestItemAssociation {
  ...
  public static List<List<String>> buildConnectedComponentsList(Map<String, Set<String>> graph,
      Set<String> seen) {
  ...
  public static void dfs(String node, Map<String, Set<String>> graph, Set<String> seen,
      List<String> list) {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(largestItemAssociation(
        itemAssociation2)); // Output: [item3, item4, item5], here we got same size, so have to sort lexicographical.
    System.out.println(
        largestItemAssociation(itemAssociation3)); // Output: [item1, item2, item3, item4, item5]
  }
}
