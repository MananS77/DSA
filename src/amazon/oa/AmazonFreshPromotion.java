...
public class AmazonFreshPromotion {
  ...
  public static boolean matchSecretLists(List<List<String>> codeList, List<String> shoppingCart) {
    ...
    while (i < codeList.size() && j + codeList.get(i).size() <= shoppingCart.size()) {
      ...
      for (int k = 0; k < codeList.get(i).size(); k++) {
        if (!codeList.get(i).get(k).equals("anything") && !codeList.get(i).get(k)
            .equals(shoppingCart.get(j + k))) {
          match = false;
          break;
        }
      }
  ...
  public static void main(String[] args) {
    List<List<String>> codeList1 = Arrays
        .asList(Arrays.asList("apple", "apple"), Arrays.asList("banana", "anything", "banana"));
    List<String> shoppingCart1 = Arrays
        .asList("orange", "apple", "apple", "banana", "orange", "banana");

    List<List<String>> codeList2 = Arrays
        .asList(Arrays.asList("apple", "apple"), Arrays.asList("banana", "anything", "banana"));
    List<String> shoppingCart2 = Arrays.asList("banana", "orange", "banana", "apple", "apple");

    List<List<String>> codeList3 = Arrays
        .asList(Arrays.asList("apple", "apple"), Arrays.asList("banana", "anything", "banana"));
    List<String> shoppingCart3 = Arrays
        .asList("apple", "banana", "apple", "banana", "orange", "banana");

    List<List<String>> codeList4 = Arrays
        .asList(Arrays.asList("apple", "apple"), Arrays.asList("apple", "apple", "banana"));
    List<String> shoppingCart4 = Arrays.asList("apple", "apple", "apple", "banana");

    List<List<String>> codeList5 = Arrays
        .asList(Arrays.asList("apple", "apple"), Arrays.asList("banana", "anything", "banana"));
    List<String> shoppingCart5 = Arrays
        .asList("orange", "apple", "apple", "banana", "orange", "banana");

    List<List<String>> codeList6 = Arrays
        .asList(Arrays.asList("apple", "apple"), Arrays.asList("banana", "anything", "banana"));
    List<String> shoppingCart6 = Arrays
        .asList("apple", "apple", "orange", "orange", "banana", "apple", "banana", "banana");

    List<List<String>> codeList7 = Arrays
        .asList(Arrays.asList("anything", "apple"), Arrays.asList("banana", "anything", "banana"));
    List<String> shoppingCart7 = Arrays
        .asList("orange", "grapes", "apple", "orange", "orange", "banana", "apple", "banana",
            "banana");

    List<List<String>> codeList8 = Arrays
        .asList(Arrays.asList("apple", "orange"), Arrays.asList("orange", "banana", "orange"));
    List<String> shoppingCart8 = Arrays
        .asList("apple", "orange", "banana", "orange", "orange", "banana", "orange", "grape");

    List<List<String>> codeList9 = Arrays
        .asList(Arrays.asList("anything", "anything", "anything", "apple"),
            Arrays.asList("banana", "anything", "banana"));
    List<String> shoppingCart9 = Arrays
        .asList("orange", "apple", "banana", "orange", "apple", "orange", "orange", "banana",
            "apple", "banana");
  ...
  public boolean matchSecretListsCommented(List<List<String>> secretFruitList,
      List<String> customerPurchasedList) {
    ...
    while (i < secretFruitList.size() && j + secretFruitList.get(i).size() <= customerPurchasedList
        .size()) {
      boolean match = true;
      for (int k = 0; k < secretFruitList.get(i).size(); k++) {
        if (!secretFruitList.get(i).get(k).equals("anything") && !secretFruitList.get(i).get(k)
            .equals(customerPurchasedList.get(j + k))) {
          match = false;
          break;
        }
        if (match) {
