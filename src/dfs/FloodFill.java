...
public class FloodFill {
    public static void main(String[] args) {
        ...
        int sr = 1, sc = 1;
        int newColor = 2;
        System.out.println("Painted Image = " + Arrays.deepToString(floodFill(matrix, sr, sc, newColor)));
    }
    ...
    private static void floodFill(int[][] image, int i, int j, int m, int n, int oldColor, int newColor) {
        if (i < 0 || i >= m || j < 0 || j >= n)
            return;
